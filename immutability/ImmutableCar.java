...
public class ImmutableCar {
  // with the final keyword, the values of the instance variables cannot be
  // changed which makes the class immutable
  ...
  public void changeMake(String newMake) {
    // this.make = newMake; // this line will throw an error because the value of
    // the instance variable make cannot be changed
  }

  // so to change the make of the car, we can create a new instance of the class
  // and pass the new make as a parameter
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\n\nOriginal Immutable Car Details");
    // print the details of the car
    immutableCar.printDetails();

    // change the make of the car
    // immutableCar.changeMake("Cephas Roys"); // this line will throw an error
    // because the value of the instance variable make cannot be changed

    // so to change the make of the car, we can create a new instance of the class
    // and pass the new make as a parameter
    ImmutableCar newImmutableCar = immutableCar.withNewMake("Cephas Roys");

    System.out.println("\n\nNew Immutable Car Details");
